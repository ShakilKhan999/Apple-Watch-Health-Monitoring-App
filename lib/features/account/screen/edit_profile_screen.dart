...
import 'package:surajashray/features/account/controller/edit_profile_controller.dart';
import 'package:surajashray/features/account/controller/profile_setup_controller.dart';
import 'package:surajashray/features/account/widget/edit_profile_widget.dart';
...
class EditProfileScreen extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              32.h.verticalSpace,
              _buildSaveSection(editProfileController),
              32.h.verticalSpace,
  ...
  Widget _buildSaveSection(EditProfileController editProfileController) {
    return Center(
      child: CustomFilledButton(
        text: 'save_button'.tr,
        onPressed: editProfileController.saveAccountData,
